...
namespace Eshop.Web.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            _unitOfWork.Save();
            HttpContext.Session.SetInt32(StaticDetail.ssShoppingCart, 0);
            ...
            else
            {
                ...
                if (charge.Id == null)
                {
                    ShoppingCartVM.OrderHeader.PaymentStatus = StaticDetail.PaymentStatusRejected;
                }
                else
                {
                ...
                {
                    ShoppingCartVM.OrderHeader.PaymentStatus = StaticDetail.PaymentStatusApproved;
                    ShoppingCartVM.OrderHeader.OrderStatus = StaticDetail.StatusApproved;
